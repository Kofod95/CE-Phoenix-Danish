...
*/
  ...
  define('MODULE_PAYMENT_SAGE_PAY_DIRECT_TEXT_DESCRIPTION', '<i class="fas fa-external-link-alt"></i>&nbsp;<a href="https://www.opayo.co.uk/support/business-support/" target="_blank" rel="noopener">Visit Sage Pay Website</a>');
